...
<div class="row mt-4">
    <div class="col-md-4 col-md-offset-4">
        <form action="<?= base_url(); ?>dashboard/services_save" method="POST" autocomplete="off">
            ...
            <div class="input-group mb-3">
                <div class="custom-file">
                    <input type="file" class="custom-file-input" id="service_pic" accept=".jpg, .jpeg, .png">
                    <input type="hidden" name="service_pic">
...
<div class="modal fade" id="modal-preview-services" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
